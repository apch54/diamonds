class Phacker.LoaderState
  ...
  preload: ->
    ...
    @game.load.spritesheet 'incent_video', root_design+'mobile/mobile_states/mobile_gameover/onemore_lifeSPR6.png', 200, 85
    ...
    #nextLevel
    @game.load.image 'lock', root_design+type+'/'+type+'_states/'+type+'_level/box_lock.png'
    @game.load.image 'level_complete', root_design+type+'/'+type+'_states/'+type+'_level/level_completed.png'
    for lvl in [1..9]
        @game.load.image 'level'+lvl, root_design+type+'/'+type+'_states/'+type+'_level/box'+lvl+'.png'
        @game.load.image 'level_hover'+lvl, root_design+type+'/'+type+'_states/'+type+'_level/hover/box'+lvl+'.png'
